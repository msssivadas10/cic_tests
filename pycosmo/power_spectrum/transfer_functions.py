...
from pycosmo._bases import Cosmology
import numpy as np
...
models = {
            'eisenstein98_wb': psmodelEisenstein98_withBaryon,
            'eisenstein98_zb': psmodelEisenstein98_zeroBaryon,
            'eisenstein98_nu': psmodelEisenstein98_withNeutrino,
            'sugiyama96'     : psmodelSugiyama96,
            'bbks'           : psmodelBBKS,
         }